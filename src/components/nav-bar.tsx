...
export default function Navbar() {
  ...
  return (
    <div
      id="header"
      className="w-full fixed top-0 shadow-md bg-transparent backdrop-blur-sm z-50 px-2 md:px-10 py-3 md:py-8"
    >
      <div className="h-full flex items-center justify-between m-auto px-[10px]">
        ...
        >
          ...
          <span
            data-aos="fade-left"
            className="font-semibold font-clash text-transparent bg-clip-text bg-gradient-brand-400-to-dark"
          >
            @vagnereix.dev
          </span>
        </a>
